...
module.exports = function (controller) {
    ...
    controller.hears( 'intro', 'message,direct_message', async ( bot, message ) => {

        let normalizedPath = require( 'path' ).join( __dirname,'guide/intro.html' , );
        let markDown = '\n';
    ...
    controller.commandHelp.push( { command: 'intro', text: 'Introduction' } );
